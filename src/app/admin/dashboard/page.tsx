  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
        <h3 className="text-lg font-semibold text-[#1A1A1A] font-['Playfair_Display'] mb-4">
          Quick Actions
        </h3>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
          <button className="flex items-center p-4 bg-[#F9CCE3]/20 rounded-lg hover:bg-[#F9CCE3]/30 transition-colors">
            <Package className="w-6 h-6 text-[#712F91] mr-3" />
            <span className="font-medium text-[#1A1A1A] font-['Poppins']">Add Product</span>
          </button>
          <button className="flex items-center p-4 bg-[#F9CCE3]/20 rounded-lg hover:bg-[#F9CCE3]/30 transition-colors">
            <FileText className="w-6 h-6 text-[#712F91] mr-3" />
            <span className="font-medium text-[#1A1A1A] font-['Poppins']">New Blog Post</span>
          </button>
          <button className="flex items-center p-4 bg-[#F9CCE3]/20 rounded-lg hover:bg-[#F9CCE3]/30 transition-colors">
            <Users className="w-6 h-6 text-[#712F91] mr-3" />
            <span className="font-medium text-[#1A1A1A] font-['Poppins']">View Customers</span>
          </button>
          <button className="flex items-center p-4 bg-[#F9CCE3]/20 rounded-lg hover:bg-[#F9CCE3]/30 transition-colors">
            <BarChart3 className="w-6 h-6 text-[#712F91] mr-3" />
            <span className="font-medium text-[#1A1A1A] font-['Poppins']">Analytics</span>
          </button>
        </div>
      </div>
    </div>
